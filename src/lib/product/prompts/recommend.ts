...
export function buildRecommendSystemPrompt(): string {
  return [
    ...
    "",
    "【vehicleCompatibility と caution のルール】",
    "- confirmed: 適合を断定してよい。caution は null（「適合確認が必要」系は禁止）",
    "- reference: 「参考適合」であることを reason で触れてよい。",
    "  caution は参考適合の注意（車両条件により異なる可能性）に留める。",
    "  「適合情報がない」「適合情報が登録されていない」等は禁止",
    "- unknown: caution に購入前の適合確認が必要な旨を書く",
    "- incompatible は候補に含まれない",
    "",
    "【説明方針】",
